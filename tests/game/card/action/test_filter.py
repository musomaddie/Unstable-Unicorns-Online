...
from unstable_unicorns_game.game.card.action.filter_type import FilterType
...
class TestCreate:
    ...
    def test_create_with_valid_filters(self, input_dict, expected_filters):
        ...
        assert set(result.filters) == set(expected_filters)
    ...
    def test_create_with_mixed_valid_invalid_filters(self):
        ...
        assert set(result.filters) == {FilterType.UPGRADE, FilterType.NONE}

...
def create_compact_view(cards: MultipleCardsHolder) -> ContainerWidget:
    widget = ContainerWidget(QHBoxLayout())
    ...
    widget.style_with_selectors(styles.player_compact_ui_labels)
...
class HandUi:
    ...
    def __init__(self, hand: Hand):
        ...
        self.compact_view = create_compact_view(hand)
